...
export const brandingData = [
  {
    ...
    Description: "Tất cả tours phù hợp",
    icon: (
      <svg
        width="36"
        height="36"
  ...
  {
    id: 2,
    title: "Ưu Đãi Bất Ngờ Trong Ngày",
    Description: "Giảm tới 25% các tours",
    icon: (
      <svg
        width="32"
        height="34"
...
export const categoriesData = [
  ...
  // },
      ...
      {
        title: "Du lịch Hà Nội Hạ Long Sapa",
      },
      {
        title: "Du lịch Đà Nẵng Hội An Huế",
      },
      {
  ...
  //   ],
  //   image_Url:
  //     "https://www.vietnambooking.com/wp-content/uploads/2019/04/tour-sapa-3-ngay-2-dem-1-150x150.jpg",
  // },
  // {
  //   id: 3,
  //   title: "Kiểu tour du lịch",
  //   submenu: true,
  //   sublinks: [
  //     {
  ...
  //   ],
  //   image_Url:
  //     "https://www.vietnambooking.com/wp-content/uploads/2019/10/tour-du-lich-da-nang-ba-na-hills-son-tra-hoi-an-galina-3n2d-2-300x194.jpg",
  // },
  // {
  //   id: 4,
  ...
  //   ],
  //   image_Url:
  //     "https://www.vietnambooking.com/wp-content/uploads/2017/04/tour-du-lich-30-4-vung-tau-5.jpg",
  // },
  // {
  //   id: 5,
  ...
  // {
  //   id: 9,
  //   title: "Du lịch Quy Nhơn Phú Yên",
  //   subTitle: "",
  //   image_Url:
