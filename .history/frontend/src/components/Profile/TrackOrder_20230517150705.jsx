    ...
    <div className="w-full h-[80vh] flex justify-center items-center">
      ...
      <>
        {data && data?.status === "Xử lý" ? (
          <h1 className="text-[20px]">Đơn hàng của bạn đang được xử lý tại đại lý.</h1>
        ) : data?.status === "Đang liên hệ với công ty" ? (
          ...
          <h1 className="text-[20px]">Đơn hàng của bạn đã được xử lý thành công!</h1>
