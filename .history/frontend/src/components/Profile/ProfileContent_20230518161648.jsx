  ...
  return (
    <div className="w-full px-5">
            ...
            <div className="w-full">
              <form aria-required onSubmit={handleSubmit} className="w-full">
                <div className="w-full block p-4">
                  ...
                  <div className="w-full pb-2">
                    <label className="block pb-2">Địa chỉ chính</label>
                    <input
                      type="address"
                  ...
                  <div className="w-full pb-2">
                    <label className="block pb-2">Địa chỉ thay thế</label>
                    <input
                      type="address"
                      className={`${styles.input}`}
                      required
      ...
      <div className="flex w-full items-center justify-between">
        ...
        >
          <span className="text-[#fff]">Thêm mới địa chỉ</span>
        </div>
      </div>
      <br />
      {user &&
      ...
      {user && user.addresses.length === 0 && (
        <h5 className="text-center pt-8 text-[18px]">Bạn chưa lưu địa chỉ!</h5>
      )}
    </div>
  );
};
