      ...
      {categoriesData &&
        categoriesData.map((i, index) => (
          ...
          >
            ...
            {i.submenu && (
              <div>
                <div className="absolute top-20 grid grid-cols-1 gap-[20px] md:grid-cols-2 md:gap-[25px] lg:grid-cols-4 lg:gap-[25px] xl:grid-cols-5 xl:gap-[30px] mb-12 border-0">
                  <div className="py-3">
