      ...
      <form onSubmit={handleSubmit}>
              ...
              categoriesData.map((i) => (
                <option value={i.title} key={i.title}>
                  ...
                  {i.sublinks.map((mysublinks) => (
                    <option
                      value={mysublinks.title}
                      key={mysublinks.title}
        ...
        <div>
          ...
          <input
            ...
            placeholder="Enter your tour price with discount..."
          />
        </div>
        <br />
        <div>
          <label className="pb-2">
            Số lượng khách tối đa của tour <span className="text-red-500">*</span>
          </label>
          <input
            type="number"
            name="price"
            ...
            placeholder="Enter your maximum guests..."
          />
        </div>
        <br />
        <div>
