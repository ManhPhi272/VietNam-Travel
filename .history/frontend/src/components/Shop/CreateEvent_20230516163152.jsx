      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <input
            ...
            placeholder="Enter your event tour name..."
          />
        </div>
        <br />
        <div>
          ...
          <textarea
            ...
            placeholder="Enter your event tour description..."
          ></textarea>
        </div>
        <br />
        <div>
        ...
        <div>
          ...
          <input
            ...
            placeholder="Enter your event tour tags..."
          />
        </div>
        <br />
        <div>
          ...
          <input
            ...
            placeholder="Enter your tour schedule..."
          />
        </div>
        <br />
        <div>
          ...
          <input
            ...
            placeholder="Enter your event tour price..."
          />
        </div>
        <br />
        <div>
          ...
          <input
            ...
            placeholder="Enter your event tour price with discount..."
          />
        </div>
        <br />
        <div>
          ...
          <input
            ...
            placeholder="Enter your event maximum guests..."
          />
        </div>
        <br />
        <div>
          ...
          <input
            ...
            min={today}
            placeholder="Enter your start event..."
          />
        </div>
        <br />
        <div>
          ...
          <input
            ...
            min={minEndDate}
            placeholder="Enter your end event product stock..."
          />
        </div>
        <br />
        <div>
