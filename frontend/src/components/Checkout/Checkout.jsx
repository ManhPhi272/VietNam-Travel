    ...
    await axios.get(`${server}/coupon/get-coupon-value/${name}`).then((res) => {
      ...
      if (res.data.couponCode !== null) {
        ...
        if (isCouponValid.length === 0) {
          toast.error("Coupon code không có sẵn");
          setCouponCode("");
        } else {
      ...
      if (res.data.couponCode === null) {
        toast.error("Coupon code không tồn tại!");
        setCouponCode("");
      }
    });
  };
...
const ShippingInfo = ({
  ...
  return (
    <div className="w-full 800px:w-[95%] bg-white rounded-md p-5 pb-8">
      <h5 className="text-[18px] font-[500]">Thông tin địa chỉ</h5>
      <br />
      <form>
